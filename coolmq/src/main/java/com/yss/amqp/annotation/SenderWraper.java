package com.yss.amqp.annotation;
...
import com.yss.amqp.sender.RabbitSender;
import com.yss.amqp.util.RabbitMetaMessage;
...
public class SenderWraper {  
    ...
    @Pointcut("@annotation(com.yss.amqp.annotation.MqSender)")
